...
public class PO_PropertyAdd extends PO_NavView {
	...
	static public void fillFormLocal(WebDriver driver, String codep, String typeOpp, String namep, String addressp,
			...
			String priceComp, boolean escaparatep, boolean aparcamientop, boolean cargaYdescargap, boolean extintoresp,
	...
	static public void confirmAddProperty(WebDriver driver) {
