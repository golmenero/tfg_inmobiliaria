...
public class TestsUseCase10 {
	...
	public void Prueba10_1(WebDriver driver, MongoDBUtils mdb) {
		...
		PO_View.checkElement(driver, "text", "Introduzca las imágenes.");
		// Comprobamos que seguimos en la tercera pantalla y muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Elija qué desea hacer con las imágenes:");
		PO_PropertyEdit.imagSelectOption(driver, "new");
		...
		PO_View.checkElement(driver, "text", "Inmueble editado correctamente.");
		...
		mdb.exists("owners",
				new Document("name", "Propietario2").append("surname", "Propietarito2").append("dni", "00000001P")
						.append("phone", 666666667).append("email", "propietario2@propietario.com")
	...
	public void Prueba10_2(WebDriver driver, MongoDBUtils mdb) {
		...
		PO_View.checkElement(driver, "text", "Edite la información del Inmueble.");
		// Rellenamos la primera pantalla
	...
	public void Prueba10_3(WebDriver driver, MongoDBUtils mdb) {
		...
		mdb.exists("properties", new Document("type", "suelo").append("code", "S100").append("typeOp", "Venta")
				.append("name", "Nombre Propiedad 1").append("description", "Descripcion propiedad 1")
				.append("city", "Ciudad1").append("situation", "Situacion1").append("area", 400).append("edifArea", 200)
	...
	public void PruebaN10_1(WebDriver driver, MongoDBUtils mdb) {
		...
		PO_View.checkElement(driver, "h2", "Edite la información del Inmueble.");
	...
	public void PruebaN10_3(WebDriver driver, MongoDBUtils mdb) {
		...
		// Comprobamos que nos muestra el mensaje de error
		PO_View.checkElement(driver, "text", "Rellene todos los campos, por favor.");
		PO_PropertyEdit.fillFormSuelo(driver, "S001", "Alquiler", "Nombre Propiedad 1", "", "Ciudad1", "Situacion1",
		...
		// Comprobamos que nos deja en la primera pantalla
		PO_View.checkElement(driver, "h2", "Edite la información del Inmueble.");
		PO_PropertyEdit.fillFormSuelo(driver, "S001", "Alquiler", "Nombre Propiedad 1", "D", "Ciudad1", "Situacion1",
				"400", "200", "700", true, false);
		// Comprobamos que nos deja en la primera pantalla
		PO_View.checkElement(driver, "h2", "Edite la información del Inmueble.");
		PO_PropertyEdit.fillFormSuelo(driver, "S001", "Alquiler", "Nombre Propiedad 1", "Descripcion propiedad 1", "C",
				"Situacion1", "400", "200", "700", true, false);
		// Comprobamos que nos deja en la primera pantalla
		PO_View.checkElement(driver, "h2", "Edite la información del Inmueble.");
		PO_PropertyEdit.fillFormSuelo(driver, "S001", "Alquiler", "Nombre Propiedad 1", "Descripcion propiedad 1",
	...
	public void PruebaN10_4(WebDriver driver, MongoDBUtils mdb) {
		...
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		// Rellenamos la pantalla vacía y probamos dejando vacíos diferentes campos
		PO_PropertyEdit.fillFormOwner(driver, "", "Propietarito1", "00000000P", "666666666",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Rellene todos los campos, por favor.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "", "00000000P", "666666666",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Rellene todos los campos, por favor.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "", "666666666",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Rellene todos los campos, por favor.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "00000000P", "",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Rellene todos los campos, por favor.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "00000000P", "666666666", "",
		...
		// Ahora comprobamos que respeta los tamaños minimos (los máximos los restringe
		// automaticamente).
		PO_PropertyEdit.fillFormOwner(driver, "P", "Propietarito1", "00000000P", "666666666",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que seguimos en la segunda pantalla
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "P", "00000000P", "666666666",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "0", "666666666",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "00000000P", "6",
				"propietario1@propietario.com", "Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "00000000P", "666666666", "p@p.c",
				"Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "00000000P", "666666666", "P",
				"Direccion Propietario 1");
		// Comprobamos que nos muestra un mensaje de error
		PO_View.checkElement(driver, "text", "Edite la información del propietario.");
		PO_PropertyEdit.fillFormOwner(driver, "Propietario1", "Propietarito1", "00000000P", "666666666",
